public class Staff {
    ...
    public Staff(){
        ...
        staffList[3] = new Hourly("Diane", "678 Fifth Ave.", "555-0690",
                "958-47-3625", 10.55);
        staffList[4] = new Volunteer("Norm", "987 Suda Blvd.",
                "555-8374");
        staffList[5] = new Volunteer("Cliff", "321 Duds Lane",
                "555-7282");
        staffList[6] = new Commission("Umar", "Jl Cipeyeum", "555-6969",
                "001-00-1101", 6.25, 0.2);
        staffList[7] = new Commission("Breh", "Bungbulang", "666-1771",
                "200-30-4004", 9.75, 0.15);
